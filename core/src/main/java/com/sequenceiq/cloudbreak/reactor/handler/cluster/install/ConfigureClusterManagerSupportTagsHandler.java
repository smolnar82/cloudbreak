...
@Component
public class ConfigureClusterManagerSupportTagsHandler implements EventHandler<ConfigureClusterManagerSupportTagsRequest> {
    ...
    @Override
    public void accept(Event<ConfigureClusterManagerSupportTagsRequest> event) {
