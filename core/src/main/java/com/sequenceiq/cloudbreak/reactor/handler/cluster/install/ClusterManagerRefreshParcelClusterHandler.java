...
@Component
public class ClusterManagerRefreshParcelClusterHandler implements EventHandler<ClusterManagerRefreshParcelRequest> {
    ...
    @Override
    public void accept(Event<ClusterManagerRefreshParcelRequest> event) {
