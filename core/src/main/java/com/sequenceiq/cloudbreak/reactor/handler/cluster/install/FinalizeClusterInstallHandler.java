...
@Component
public class FinalizeClusterInstallHandler implements EventHandler<FinalizeClusterInstallRequest> {
    ...
    @Override
    public void accept(Event<FinalizeClusterInstallRequest> event) {
