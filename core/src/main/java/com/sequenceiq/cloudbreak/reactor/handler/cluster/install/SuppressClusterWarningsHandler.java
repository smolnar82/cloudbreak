...
@Component
public class SuppressClusterWarningsHandler implements EventHandler<SuppressClusterWarningsRequest> {
    ...
    @Override
    public void accept(Event<SuppressClusterWarningsRequest> event) {
