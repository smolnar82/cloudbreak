...
@Component
public class ValidateClusterLicenceHandler implements EventHandler<ValidateClusterLicenceRequest> {
    ...
    @Override
    public void accept(Event<ValidateClusterLicenceRequest> event) {
